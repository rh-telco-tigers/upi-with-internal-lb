...
IGNITION_FILE=$(openstack image create --disk-format=raw --container-format=bare --file install-dir/custom-bootstrap.ign ocp-$INFRA_ID-bootstrap.ign -f json | jq -r .file)
